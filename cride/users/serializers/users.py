...
class UserSignUpSerializer(serializers.Serializer):
    ...
    Handle the sign up data validation and user/profile creation.
    """
    ...
    def create(self, data):
        ...
        data.pop('confirm_password') # Remove confirm_password field
    ...
    def gen_verification_token(self, user):
        ...
        payload = {
            'user': user.username,
            'exp': int(exp_date.timestamp()), # exp date in seconds
