# Generated by Django 2.0.10 on 2022-07-26 14:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_limited', models.BooleanField(default=False, help_text='Limited circles can only be joined by invitation.', verbose_name='Limited circle')),
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If circle is limited, this will be the maximum number of members allowed.')),
            ],
            options={
