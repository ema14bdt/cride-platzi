...
class Circle(CRideModel):
    ...
    by its members. To join a circle user must receive an unique
    ...
    members = models.ManyToManyField(
        ...
        help_text="List of users that belong to this circle."
    )
    ...
    is_limited = models.BooleanField(
        'Limited circle',
        default=False,
        help_text='Limited circles can only be joined by invitation.'
    )
    members_limit = models.PositiveIntegerField(
        default=0,
        help_text='If circle is limited, this will be the maximum number of members allowed.'
    )
