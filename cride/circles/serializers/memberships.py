...
class AddMemberSerializer(serializers.Serializer):
    ...
    user = serializers.HiddenField(default=serializers.CurrentUserDefault()) # Gracias a que le enviamos el contexto, el serializer puede identificar al usuario logueado.

    def validate_user(self, data):
        """Verify user isn't already a member."""
        circle = self.context['circle']
        user = data # Es una instancia del objecto user, ref linea 53
